...
public class ClienteQuery_QV_JJ58_LDD89 implements IGridRowDeleting {
	/**
	 * Instancia de Logger
	 */
	...
	@Reference(bind="setBliEliminarCliente",
			...
			target="(bli.id=BLI1278_bli_eliminarcliente)")
	...
	public void rowAction(DataEntity arg0, IGridRowActionEventArgs arg1) {
		...
		try {
			...
			logger.logDebug("Eliminando cliente...");
			bliEliminarCliente.execute(arg1.getDynamicRequest());
			logger.logDebug("Cliente eliminado");
		} catch (Exception ex) {
